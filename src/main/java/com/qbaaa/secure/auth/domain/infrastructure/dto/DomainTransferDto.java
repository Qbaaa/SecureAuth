...
public record DomainTransferDto(
    ...
    @NotNull @Positive Integer accessTokenValidity,
    @NotNull @Positive Integer refreshTokenValidity,
    @NotNull @Positive Integer emailTokenValidity,
    @NotNull @Positive Integer sessionValidity,
  ...
  public DomainTransferDto(
    ...
    this.isEnabledVerifiedEmail =
        isEnabledVerifiedEmail != null ? isEnabledVerifiedEmail : Boolean.FALSE;
    this.users = users;
    this.roles = roles;
  }
}
