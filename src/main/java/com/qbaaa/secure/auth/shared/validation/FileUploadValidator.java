package com.qbaaa.secure.auth.shared.validation;
...
public class FileUploadValidator {
  ...
  private static final List<String> ALLOWED_MIME_TYPES = List.of("application/json");
    ...
    try {
      ...
      if (!validExtension) {
        throw new UnSupportedFileException(
            "Allowed extension for file " + Arrays.toString(ALLOWED_EXTENSIONS.toArray()));
      }
