...
public class CustomJwtAuthenticationToken extends AbstractAuthenticationToken {
    ...
    private CustomJwtAuthenticationToken(Object token, String issuer, Collection<? extends GrantedAuthority> authorities) {
        super(authorities);
        this.principal = token;
        this.credentials = token;
        this.token = token;
    ...
    public static CustomJwtAuthenticationToken authenticated(Object token, String issuer, Collection<? extends GrantedAuthority> authorities) {
