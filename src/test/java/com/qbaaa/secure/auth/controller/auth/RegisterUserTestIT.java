...
class RegisterUserTestIT {
    ...
    void shouldRegisterUser() {
        try {
            ...
            // when
            mockMvc.perform(MockMvcRequestBuilders.post(API_POST_REGISTER, domainName)
                    ...
                    .andExpect(result -> {
                        ...
                        assertAll(
                                ...
                                () -> Assertions.assertEquals(2, userRepositoryTest.countByDomainName(domainName)),
                                () -> {
                                    var addingUser = userRepositoryTest.findByDomainNameAndUsername(domainName, username);
