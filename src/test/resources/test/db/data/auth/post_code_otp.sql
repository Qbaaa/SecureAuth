...
VALUES (108, 100, 'userOtpEmail', 'user008@test.com', true, false, 'EMAIL',
        '2025-03-27 22:35:00', '2025-03-28 22:35:00', 1, CURRENT_TIMESTAMP)
     , (109, 100, 'userOtpSMS', 'user009@test.com', true, false, 'SMS',
        '2025-03-27 22:35:00', '2025-03-28 22:35:00', 1, CURRENT_TIMESTAMP)
;

INSERT INTO secureauth."password" (id, user_id, "password", created_at, updated_at)
VALUES (8, 108, '$2a$10$DmZD6S035DEW3nsbJYb3zOdnHWohNzL8bq60auttuwQu/X36pdLky', -- secretUser002
        '2025-03-27 22:35:00', '2025-03-27 22:35:00')
     , (9, 109, '$2a$10$DmZD6S035DEW3nsbJYb3zOdnHWohNzL8bq60auttuwQu/X36pdLky', -- secretUser002
        '2025-03-27 22:35:00', '2025-03-27 22:35:00')
;
...
VALUES (108, 101,'2025-03-25 22:32:00')
     , (108, 102,'2025-03-25 22:33:00')
;
